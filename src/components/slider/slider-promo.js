                ...
                <div className="card-body">
                    <form onSubmit={this.handleSubmit}>
                        ...
                        <div className="form-row col-12 form-group">
                            <div className="col-6">
                                <div>
                                    <label className="text-left"><strong >Start Date</strong></label> 
                                </div>
                                <DatePicker
                            ...
                            <div className="col-6 form-group">
                                <div>
                                    <label className="text-left"><strong > End Date</strong></label>
                                </div>
                                <DatePicker
                                    className="form-control"
                        ...
                        <div className="form-row col-12 form-group ">
                            ...
                            <div className="col-7">
                                <Field className="form-control " name="title" component="input" type="text" placeholder="Promo title"/>
                            </div>
                        ...
                        <div className="form-row col-12 form-group">
                            ...
                            <div className="col-7">
                                <Field className="form-control " name="caption" component="input" type="text" placeholder="Promo caption"/>
                            </div>
                            <div className="col-1">
...
SliderPromo = reduxForm({
    // a unique name for the form
    form: 'promo'
  })(SliderPromo)

const selector = formValueSelector('promo')

export default connect(mapStateToProps, mapDispatchToProps)(SliderPromo);